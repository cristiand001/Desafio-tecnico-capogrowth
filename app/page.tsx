  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center">
      <div className="text-center">
        <div className="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-white shadow-lg mb-6">
          <svg
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12 pt-8">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
              Analyze your MercadoLibre listings with AI-powered recommendations
              to boost conversions and maximize sales performance.
            </p>
          </div>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8 pt-4">
          ...
          <p className="text-lg text-slate-600">
            Enter a listing ID to get AI-powered insights
          </p>
        </div>
        ...
        {loading && (
          <div className="text-center py-16 bg-white rounded-2xl shadow-lg border border-slate-200">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-blue-100 to-purple-100 mb-6">
              <svg
            ...
            <p className="text-slate-600">
              This may take a few seconds while we fetch data and run AI
              analysis.
            </p>
          </div>
        )}
        ...
        <footer className="text-center py-8 mt-12 text-slate-500 text-sm">
          <p>Powered by Groq AI • Built with Next.js & Supabase</p>
        </footer>
      </div>
    </div>
  );
